...
const reasoningOptions = computed<Array<{ value: ReasoningEffort; label: string }>>(() => [
  { value: 'none', label: t('rNone') },
  { value: 'minimal', label: t('rMinimal') },
  { value: 'low', label: t('rLow') },
  { value: 'medium', label: t('rMedium') },
  { value: 'high', label: t('rHigh') },
  { value: 'xhigh', label: t('rExtraHigh') },
  ])
...
const placeholderText = computed(() =>
  props.activeThreadId ? t('composerPlaceholder') : t('composerSelectThread'),
)
